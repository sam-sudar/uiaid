...
function Navbar() {
  return (
    <header className="relative z-10 bg-transparent flex items-center justify-between px-8 py-6">
      ...
      <button className="border border-blue-400 text-blue-500 px-4 py-2 rounded-full hover:bg-blue-50">
        Login
      </button>
    </header>
  );
